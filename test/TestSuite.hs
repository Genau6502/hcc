...
tests :: [TestGroup]
tests = [ tokeniserTests, parseAtomTests, parseExprTests, parseStmtTests, parseBlockTests, parseDeclaratorTests, parseAbstractDeclaratorTests, typeCheckTests, compileBlockTests
    ]
