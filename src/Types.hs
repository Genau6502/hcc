...
data Atom = IntAtom Int | CharAtom Char | ParenAtom Expr | ValAtom String | CastAtom Type | VarAtom Var
    deriving (Eq, Show)
...
data Error = Unexpected | IntegerParseError String | UnexpectedToken String | NoMoreTokens | InvalidChar String | ExpectedChar Token | ExpectedInt Token | InvalidType [Token] | VariableAlreadyDeclared String
    deriving (Eq, Show)
